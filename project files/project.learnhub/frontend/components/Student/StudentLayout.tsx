...
const StudentLayout: React.FC = () => {
  ...
  const navigation = [
    ...
    { name: 'Skill Assessment', href: '/student/assessment', icon: ClipboardCheck },
    { name: 'Workshops', href: '/student/workshops', icon: Video },
    { name: 'Discussion Board', href: '/student/discussions', icon: MessageSquare },
